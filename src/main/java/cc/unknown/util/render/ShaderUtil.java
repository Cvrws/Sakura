...
public class ShaderUtil implements Accessor {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                case "roundRectOutline":
                    fragmentShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("sakura/shader/roundRectOutline.frag")).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
                case "roundedRect":
                    fragmentShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("sakura/shader/roundedRect.frag")).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
                default:
                    try {
                        fragmentShaderID = createShader(
                            mc.getResourceManager().getResource(new ResourceLocation(fragmentShaderLoc)).getInputStream(), 
                            GL_FRAGMENT_SHADER
                        );
                    } catch (IOException e) {
                        e.printStackTrace();
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "sakura/shader/vertex.vsh");
    }
